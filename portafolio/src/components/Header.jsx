...
function Header() {
    ...
    <header id="i" className="min-h-screen pt-20 bg-gray-900 flex flex-col items-center">
        <div className='relative w-3/4 md:w-2/5  bg-black rounded-full shadow-lg shadow-cyan-500'>
            <img className='absolute w-full' src={iconImage} alt="" />
            <img src={protraitImage} alt="frontal photo" className='rounded-full  hover:opacity-0  transition-all duration-700 relative w-full'/>
        </div>
